...
WORKSPACE="/import/c4dm-05/ll307/workspace/MIDI-quantisation"
...
MV2H_path="/import/c4dm-05/ll307/tools/MV2H/bin"
...
option="evaluate"  # "train", "test" or "evaluate", or "evaluate_mv2h"
...
# model_checkpoint="/import/c4dm-05/ll307/MIDI-quantisation/checkpoints/baseline-epoch=40-val_f_beat=0.6912.ckpt"
# note sequence model final version
# model_checkpoint="/import/c4dm-05/ll307/workspace/MIDI-quantisation/mlruns/7/e32c1cdaa41b4733959998d34783deeb/checkpoints/epoch=251-val_f_beat=0.8962.ckpt"
# proposed model final version
# v1
model_checkpoint="checkpoints/proposed_v1-epoch=105-val_f_beat=0.8682.ckpt"
# v2
# model_checkpoint="/import/c4dm-05/ll307/workspace/MIDI-quantisation/mlruns/9/08f633f558e34afea9ba4f204c8dd9ef/checkpoints/last.ckpt"
